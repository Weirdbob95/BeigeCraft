...
public class Font {
    ...
    private static final ShaderProgram FONT_SHADER = Resources.loadShaderProgram("font");
    ...
    public class FontText {
        ...
        public void draw2dCentered(Vec2d position, double rotation, double scale, Vec4d color) {
            draw2d(position.sub(new Vec2d(width / 2 * scale, 0)), rotation, scale, color);
        }

        public void draw2dCentered(Vec2d position, double rotation, double scale, Vec4d color, Vec4d outlineColor) {
            draw2d(position.sub(new Vec2d(width / 2 * scale, 0)), rotation, scale, color, outlineColor);
        }
    }
}
